    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-10 flex w-full flex-col items-center">
                ...
                {/* box outter circle */}
                <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-[#141516] font-semibold text-xs overflow-hidden">
                    {logoUrl ? (
                        <img src={logoUrl} alt="Logo" className="w-full h-full object-cover" />
                    ) : (
                        <span className="text-white">{circleText ? circleText : "SVG"}</span>
                    )}
                </div>
                {/* box content */}
