...
const activities: ActivityData[] = [
    {
        label: "MOVE",
        value: 78,
        color: "#FF4081", // Brand identity pink
        size: 200,
        current: 650,
        target: 800,
        unit: "CAL",
    },
    {
        label: "EXERCISE",
        value: 65,
        color: "#69F0AE", // Brand identity light green
        size: 160,
        current: 24,
        target: 30,
        unit: "MIN",
    },
    {
        label: "STAND",
        value: 43,
        color: "#448AFF", // Brand identity blue
        size: 120,
        current: 5,
        target: 12,
        unit: "HR",
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop
                                ...
                                style={{
                                    stopColor:
                                        data.color === "#FF4081" // Brand identity pink
                                            ? "#FF2D55" // Original red
                                            : data.color === "#69F0AE" // Brand identity light green
                                                ? "#A3F900" // Original green
                                                : "#04C7DD", // Original blue
                                    stopOpacity: 1,
                                }}
                            />
                        </linearGradient>
