...
const FunctionalTraining = () => {
    useEffect(() => {
        document.title = "Functional Training in Rajkot | MZ Fitness Hub";
        window.scrollTo(0, 0);
    }, []);
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            >
                                ...
                                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-normal text-gray-900 mb-8 leading-[1.1]">
                                    Dynamic <span className="text-orange-500 italic">Functional</span> <br /> Training
                                </h1>
                                <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed max-w-lg">
                                    Prepare your body for daily life with movements that mimic real-world activities, improving strength, balance, and flexibility.
                                </p>
