...
const Yoga = () => {
    useEffect(() => {
        document.title = "Yoga in Rajkot | MZ Fitness Hub";
        window.scrollTo(0, 0);
    }, []);
                ...
                <section className="relative pt-32 pb-16 sm:pt-40 sm:pb-20 overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            >
                                <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-purple-200 bg-purple-50/50 text-purple-700 text-sm font-medium mb-8 backdrop-blur-sm">
                                    <Flower className="w-4 h-4 mr-2" />
                                    Mind & Body
                                </div>
                                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-normal text-gray-900 mb-8 leading-[1.1]">
                                    Serene <span className="text-purple-500 italic">Yoga</span> <br /> Sanctuary
                                </h1>
                                <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed max-w-lg">
                                    Discover inner peace, improve flexibility, and strengthen your body with our holistic yoga sessions.
                                </p>
                                <div className="flex flex-wrap gap-5">
                                    <Link to="/contact" className="px-8 py-4 bg-gray-900 text-white rounded-full font-medium hover:bg-purple-500 transition-all duration-300 shadow-lg hover:shadow-purple-500/25">
                                        Join a Session
                                    </Link>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {features.map((feature, index) => (
                                <motion.div
                                    ...
                                    className="group p-8 rounded-2xl bg-white/40 border border-white/50 hover:bg-white/80 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-500 backdrop-blur-sm"
                                >
