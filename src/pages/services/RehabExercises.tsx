...
const RehabExercises = () => {
    useEffect(() => {
        document.title = "Rehabilitation Exercises in Rajkot | MZ Fitness Hub";
        window.scrollTo(0, 0);
    }, []);
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            >
                                ...
                                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-normal text-gray-900 mb-8 leading-[1.1]">
                                    Effective <span className="text-orange-500 italic">Rehabilitation</span> <br /> Exercises
                                </h1>
                                <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed max-w-lg">
                                    Scientifically designed exercise programs to restore function, rebuild strength, and accelerate your recovery journey.
                                </p>
                ...
                <section className="py-24 relative">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-20">
                            ...
                            >
                                Our Rehabilitation Focus Areas
                            </motion.h2>
                            <motion.div
