...
const PainManagement = () => {
    useEffect(() => {
        document.title = "Pain Management in Rajkot | MZ Fitness Hub";
        window.scrollTo(0, 0);
    }, []);
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            >
                                ...
                                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-normal text-gray-900 mb-8 leading-[1.1]">
                                    Advanced <span className="text-orange-500 italic">Pain</span> <br /> Management
                                </h1>
                                <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed max-w-lg">
                                    Evidence-based pain relief techniques combined with personalized care to help you live without limitations.
                                </p>
                                <div className="flex flex-wrap gap-5">
                                    ...
                                    <Link to="/physio-in-rajkot" className="px-8 py-4 bg-transparent border border-gray-300 text-gray-900 rounded-full font-medium hover:bg-white hover:border-gray-400 transition-all duration-300">
                                        Back to Physio
                                    </Link>
                                </div>
                            </motion.div>
                            ...
                            >
                                <div className="relative w-full aspect-[4/5] lg:aspect-auto lg:h-full rounded-3xl overflow-hidden shadow-2xl border border-white/20">
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white/20 group">
                                        <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors duration-500"></div>
                                        <Heart className="w-32 h-32 relative z-10 opacity-50" strokeWidth={1} />
                                    </div>
                                </div>
                                {/* Decorative elements */}
                ...
                <section className="py-24 relative">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-20">
                            ...
                            >
                                Our Pain Management Specialties
                            </motion.h2>
                            <motion.div
