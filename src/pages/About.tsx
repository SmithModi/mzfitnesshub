          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-base text-gray-600 mb-4 leading-relaxed">
                <span className="font-bold">Located in the heart of Rajkot at Anant Chaya Complex, MZ Fitness Hub was born from a passion to transform lives through fitness.</span> 
